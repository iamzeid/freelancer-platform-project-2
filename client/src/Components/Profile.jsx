  ...
  return (
    <>
      ...
      <div className="container py-5 mt-5">
        <h1 className="text-center text-success animated fadeInDown">Profile</h1>
        {loading && <p className="animated fadeIn text-muted">Loading...</p>}
        {error && <p className="animated shake text-danger">Error fetching user</p>}
      ...
      <h2 className="h3 mb-3">{user.username}</h2>
          ...
          <h5 className="mb-3">About Freelancer</h5>
            <p className="text-muted w-75">{user.About_Freelancer}</p>
